...
function Start() {
  ...
  const createRoom = () => {
    socket.emit("createRoom", playerName, gender); // ✅ Send player name
    setShowPopup(true);
  };
  ...
  const joinRoom = () => {
    ...
    socket.emit("joinRoom", { roomId: roomToJoin, playerName, gender }); // ✅ Send player name
          ...
          {players.length >= 2 && (
            <div style={{ display: "flex", alignItems: "center", gap: "20px" }}>
              ...
              <div style={{ textAlign: "center", position: "relative" }}>
                ...
                <img
                  src={players[0].gender === "male" ? maleAvatar : femaleAvatar}
                  alt="Player Profile"
                  style={{
                    width: 50,
                    height: 50,
              ...
              <div style={{ textAlign: "center", position: "relative" }}>
                ...
                <img
                  src={
                    players[1].gender === "female" ? femaleAvatar : maleAvatar
                  }
                  alt="Player Profile"
                  style={{
                    width: 50,
